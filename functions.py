...
>>>>>>> 60649e3cdaefe277a5166f7045be81a8c9392300
...
<<<<<<< HEAD
        victim_sex_fig= px.bar(x=["Feminino","Masculino"], y=dummy_data[["vitimas_feminino","vitimas_masculino"]].sum(), title="Sexo", color=["Feminino", "Masculino"], color_discrete_map=dict(zip(['Feminino','Masculino'],["#e56a5d", "#19058c"])))
        victim_age_fig= px.bar(x=["0-10","11-17","18-25","25-35","36-45","46-55","55-65","65+"], y=dummy_data[['vitima_0_10','vitima_11_17','vitima_18_25','vitima_26_35','vitima_36_45','vitima_46_55','vitima_56_64','vitima_65+']].sum(), color_discrete_sequence=["#19058c"])
        victim_mariptual_state_fig= px.bar(x=['Casado','Divorciado','Separado','Solteiro','União de Facto','Viúvo'], y=dummy_data[['vitima_casado','vitima_divorciado','vitima_separado','vitima_solteiro','vitima_uniao_de_facto','vitima_viuvo']].sum(), color_discrete_sequence=["#19058c"])
        victim_relation_woffender_fig= px.bar(x=['Conjuge','Companheiro','Filho','Ex Companheiro','Progenitor','Outro'], y=dummy_data[['rel_agr_conjuge','rel_agr_companheiro','rel_agr_filho','rel_agr_ex_companheiro','rel_agr_progenitor','rel_agr_outro']].sum(), color_discrete_sequence=["#19058c"])
        offender_sex_fig= px.bar(x=["Feminino","Masculino"], y=dummy_data[["autor_crime_feminino","autor_crime_masculino"]].sum(), color=["Feminino", "Masculino"], color_discrete_map=dict(zip(['Feminino','Masculino'],["#e56a5d", "#19058c"])))
        offender_age_fig= px.bar(x=["0-17","18-25","25-35","36-45","46-55","55-65","65+"], y=dummy_data[['autor_crime_0_17','autor_crime_18_25','autor_crime_26_35','autor_crime_36_45','autor_crime_46_55','autor_crime_56_64','autor_crime_65+']].sum(), color_discrete_sequence=["#19058c"])
        ...
        offender_relation_wvictim_fig= px.bar(x=['Conjuge','Companheiro','Filho','Ex Companheiro','Progenitor','Outro'], y=dummy_data[['rel_agr_conjuge','rel_agr_companheiro','rel_agr_filho','rel_agr_ex_companheiro','rel_agr_progenitor','rel_agr_outro']].sum(), color_discrete_sequence=["#19058c"])
        criminal_fact_type_fig= px.bar(x=["Feminino","Masculino"], y=dummy_data[["vitimas_feminino","vitimas_masculino"]].sum(),color=["Masculino", "Feminino"], color_discrete_map=dict(zip(['Masculino','Feminino'],["#19058c",  "#e56a5d"])))
        criminal_fact_duration_fig= px.bar(x=["1-6 Meses","7-12 Meses","2-6 Anos", "7-11 Anos", "12-25 Anos", "26-40 Anos", "40+ Anos"], y=dummy_data[['duracao_vitimacao_1_6_m','duracao_vitimacao_7_12_m','duracao_vitimacao_2_6_a','duracao_vitimacao_7_11_a','duracao_vitimacao_12_25_a','26_40_anos','40_mais_anos']].sum(), color_discrete_sequence=["#19058c"])
        criminal_fact_local_fig = px.bar(x=["Feminino","Masculino"], y=dummy_data[["vitimas_feminino","vitimas_masculino"]].sum(),color=["Masculino", "Feminino"], color_discrete_map=dict(zip(['Masculino','Feminino'],["#19058c",  "#e56a5d"])))
=======
